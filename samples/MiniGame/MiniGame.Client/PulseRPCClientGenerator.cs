...
namespace MiniGame.Client
{
    ...
    [PulseClientGeneration(typeof(AuthStreamingHub), WithResultType = typeof(AuthStreamingHub))]
    // 由于GameStreamingHub继承自IUserStreamingHub和INotificationReceiver，需要单独生成
    [PulseClientGeneration(typeof(GameStreamingHub), WithResultType = typeof(GameStreamingHub))]
    // 单独生成通知接收器
