...
namespace DistributedGameApp.Infrastructure.Authentication;
...
public class JwtService : IJwtTokenService
{
    ...
    /// <summary>
    /// 生成令牌（GameServer/BattleServer 不需要生成令牌，但需要实现接口）
    /// </summary>
    public Task<string> GenerateTokenAsync(string userId, HashSet<string> permissions, HashSet<string> roles)
    {
        throw new NotSupportedException("GameServer/BattleServer does not generate JWT tokens. Tokens should be generated by LoginServer.");
    }
}
