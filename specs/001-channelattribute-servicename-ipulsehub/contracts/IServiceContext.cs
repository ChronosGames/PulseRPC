// Contract: IServiceContext Interface
// Purpose: Provides access to service-specific context during request processing
// Location: PulseRPC.Abstractions/Scheduling/IServiceContext.cs

namespace PulseRPC.Scheduling;

/// <summary>
/// Provides access to service-specific context, including the ServiceId for scheduling.
/// </summary>
