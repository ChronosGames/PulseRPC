    ...
    public void AddPulseClustering_MustRegisterDefaultLoadMetricsForLeastLoadedStrategyPlugins()
    {
        ...
        services.AddPulseClustering(
            topology =>
            {
                ...
                topology.Members.Add(new ClusterNodeEndpoint { NodeId = "node-a", Host = "127.0.0.1", Port = 19001 });
                topology.Members.Add(new ClusterNodeEndpoint { NodeId = "node-b", Host = "127.0.0.1", Port = 19002 });
            },
