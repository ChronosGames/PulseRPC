...
public static class CompilationHelper
{
    public static (Compilation Compilation, SemanticModel SemanticModel) Create(string code)
    {
        ...
        var references = new MetadataReference[]
        {
            ...
            MetadataReference.CreateFromFile(typeof(MemoryPack.MemoryPackSerializer).Assembly.Location), // MemoryPack
            MetadataReference.CreateFromFile(typeof(PulseRPC.Client.PulseTcpConnection).Assembly.Location), // PulseRPC.Client
        };
