...
/// <summary>
/// Stable method identity used only for generator lookup and generated C# identifiers.
/// This is deliberately separate from the canonical protocol signature so existing wire IDs do not change.
/// </summary>
internal static class MethodIdentity
{
    ...
    public static string CreateGeneratedIdentifier(IMethodSymbol method, ushort protocolId)
        => $"{method.Name}_{protocolId:X4}";
