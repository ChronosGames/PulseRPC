...
public class ConsulServiceDiscovery : IServiceDiscovery, IServiceRegistry, IDisposable
{
    ...
    private ServiceRegistration? ConvertToServiceRegistration(AgentService consulService)
    {
        var metadata = new Dictionary<string, string>();
    ...
    private AgentServiceRegistration ConvertToConsulRegistration(ServiceRegistration registration)
    {
        var metadata = new Dictionary<string, string>();
