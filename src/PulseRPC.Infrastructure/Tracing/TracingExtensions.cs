...
public static class TracingExtensions
{
        ...
        string? collectorEndpoint = null)
    {
        services.Configure<TracingOptions>(options =>
        {
            ...
            {
                AgentHost = agentHost, AgentPort = agentPort, CollectorEndpoint = collectorEndpoint
            };
        });
        ...
        bool useShortTraceIds = false)
    {
        services.Configure<TracingOptions>(options =>
        {
            ...
            {
                Endpoint = endpoint, UseShortTraceIds = useShortTraceIds
            };
        });
        ...
        bool useTls = false)
    {
        services.Configure<TracingOptions>(options =>
        {
            ...
            {
                Endpoint = endpoint, Protocol = protocol, UseTls = useTls
            };
        });
        ...
        ISpan? parentSpan = null)
    {
        ...
        {
            ["rpc.service"] = serviceName, ["rpc.method"] = methodName, ["rpc.system"] = "pulserpc"
        };
        ...
        ISpan? parentSpan = null)
    {
        ...
        var tags = new Dictionary<string, object>
        {
            ["http.method"] = method, ["http.url"] = url, ["component"] = "http-client"
        };
        ...
        ISpan? parentSpan = null)
    {
        ...
        var tags = new Dictionary<string, object>
        {
            ["db.operation"] = operation, ["db.table"] = table, ["component"] = "database-client"
        };
