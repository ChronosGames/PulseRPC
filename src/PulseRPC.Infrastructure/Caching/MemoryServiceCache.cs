...
// /// 基于内存的服务缓存实现
// /// </summary>
// public class MemoryServiceCache : ICacheService
// {
...
//         if (_memoryCache is MemoryCacheEntryOptions memoryCache)
//         {
...
//
//         // 尝试获取内存缓存的统计信息
//         if (_memoryCache is MemoryServiceCache memoryCache)
//         {
//             // 这些属性可能需要反射访问，因为它们是内部的
//             try
//             {
//                 var field = typeof(MemoryServiceCache).GetField("_options",
//                     System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
//
//                 if (field?.GetValue(memoryCache) is CachingOptions options)
//                 {
//                     stats["SizeLimit"] = options.MaxEntries.ToString() ?? "Unlimited";
//                 }
//             }
//             catch (Exception ex)
//             {
