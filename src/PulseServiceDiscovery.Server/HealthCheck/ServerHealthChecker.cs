...
public class HealthCheckState
{
    ...
    public HealthStatus CurrentHealth { get { lock (_lock) return _currentHealth; } }
    public HealthStatus PreviousHealth { get { lock (_lock) return _previousHealth; } }
    public int ConsecutiveFailures { get { lock (_lock) return _consecutiveFailures; } }
    public int ConsecutiveSuccesses { get { lock (_lock) return _consecutiveSuccesses; } }
    public DateTime LastCheckTime { get { lock (_lock) return _lastCheckTime; } }
