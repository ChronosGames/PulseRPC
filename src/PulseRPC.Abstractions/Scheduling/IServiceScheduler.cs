...
/// </summary>
public interface IServiceScheduler : IAsyncDisposable
{
    /// <summary>
    ...
    /// <exception cref="InvalidOperationException">If ServiceId is not set in the key or scheduler not started.</exception>
