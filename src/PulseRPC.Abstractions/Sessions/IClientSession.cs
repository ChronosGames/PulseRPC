...
public sealed class SessionHealthCheckResult
{
    ...
    /// 健康状态
    /// </summary>
    public SessionHealth Health { get; set; }
...
public sealed class SessionHealthChangedEventArgs : EventArgs
{
    ...
    /// 之前的健康状态
    /// </summary>
    public SessionHealth PreviousHealth { get; set; }

    /// <summary>
    /// 当前的健康状态
    /// </summary>
    public SessionHealth CurrentHealth { get; set; }
...
public sealed class SessionGroupsChangedEventArgs : EventArgs
{
    ...
    /// 之前的组列表
    /// </summary>
    public IReadOnlyList<string> PreviousGroups { get; set; } = Array.Empty<string>();

    /// <summary>
    /// 当前的组列表
    /// </summary>
    public IReadOnlyList<string> CurrentGroups { get; set; } = Array.Empty<string>();
