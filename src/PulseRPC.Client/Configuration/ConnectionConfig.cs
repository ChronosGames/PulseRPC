...
public sealed class ConnectionPoolOptions
{
    ...
    /// 创建固定大小连接池配置
    /// </summary>
    public static ConnectionPoolOptions FixedSize(int size, TimeSpan? idleTimeout = null)
    {
    ...
    /// 创建动态大小连接池配置
    /// </summary>
    public static ConnectionPoolOptions Dynamic(int minSize, int maxSize, TimeSpan? idleTimeout = null)
    {
        return new ConnectionPoolOptions
        {
