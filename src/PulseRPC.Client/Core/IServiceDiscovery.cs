...
public sealed record ServiceEndpoint
{
    ...
    /// 端点地址
    /// </summary>
    public required EndpointAddress Address { get; init; }
    ...
    /// 健康状态
    /// </summary>
    public ServiceEndpointHealth Health { get; init; } = ServiceEndpointHealth.Unknown;
...
public sealed record ServiceDiscoveryResult
{
    ...
    /// 查询条件
    /// </summary>
    public required ServiceDiscoveryQuery Query { get; init; }
...
public sealed record LoadBalancingContext
{
    ...
    /// 排除的端点（已失败的端点）
    /// </summary>
    public IReadOnlySet<string> ExcludedEndpoints { get; init; } = new HashSet<string>();
