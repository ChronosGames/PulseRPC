...
// // 示例服务接口
// /// <summary>
// /// 认证服务接口 - 使用新的IPulseHub接口
// /// </summary>
// public interface IAuthenticationService : IPulseHub
// {
//     Task<LoginResult> LoginAsync(string email, string password);
// }
//
// /// <summary>
// /// 用户服务接口 - 使用新的IPulseHub接口
// /// </summary>
...
//
// /// <summary>
// /// 订单服务接口 - 使用新的IPulseHub接口
// /// </summary>
// public interface IOrderService : IPulseHub
// {
//     Task<IReadOnlyList<Order>> GetOrdersAsync(string customerId);
// }
//
// /// <summary>
// /// 数据库服务接口 - 使用新的IPulseHub接口
// /// </summary>
// public interface IDatabaseService : IPulseHub
// {
//     Task<QueryResult> ExecuteQueryAsync(string sql);
// }
//
// /// <summary>
// /// API服务接口 - 使用新的IPulseHub接口
// /// </summary>
// public interface IApiService : IPulseHub
// {
